        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              <li>
                <a href="tel:+917807464389" className="flex items-center gap-3 hover:text-white transition-colors">
                  <Phone size={14} className="text-royal-gold flex-shrink-0" /> +91-7807464389
                </a>
              </li>
              <li>
